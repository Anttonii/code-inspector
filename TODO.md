...
- [ ] Recursive function invocations get improperly recorded on the inspector pane, namely in the backtrack step
  - [ ] Add frame information to the trace step and rewrite frontend trace grouping by frame id.
- [ ] Refactor TraceStep to be a frozen dataclass
